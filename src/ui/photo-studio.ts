...
export class PhotoStudio {
  ...
  private fillCamera() {
    (this.element.querySelector('#photo-focusSubject') as HTMLSelectElement).value = String(
      this.settings.focusSubject,
    );
