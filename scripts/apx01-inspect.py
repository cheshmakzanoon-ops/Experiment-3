...
for name,az,elev,distance,focus in [('three-quarter',38,14,8.6,(0,0,.55)),('side',90,5,9.4,(0,0,.55)),('front',0,8,8.2,(0,0,.53)),('rear',180,10,7.3,(0,0,.55)),('front-mechanical',70,20,2.7,(.7,-1.6,.35)),('rear-mechanical',155,15,3.3,(0,1.8,.5))]:
